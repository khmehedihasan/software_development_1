...
#include "../../../tabulate/table.hpp"
    ...
    void editCustomer(){
        ...
        customers* EC = findCustomer(customerId);
            ...
            cout<<"Current supplier name : ->[ " <<EC->name <<" ]" <<endl;
            string nam;
            ...
            cout<<"Current supplier email : ->[ " <<EC->email <<" ]" <<endl;
            ...
            cout<<"Current supplier phone : ->[ " <<EC->phone <<" ]" <<endl;
            ...
            cout<<"Current supplier address : ->[ " <<EC->address <<" ]" <<endl;
